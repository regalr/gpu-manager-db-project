create or replace package pkg_functions is
       ...
       function sales_per_country(p_country string default '') return ty_sales_per_country_l;
...
--- vendor country
      ...
      begin
        ...
        SELECT ty_sales_per_country(t.country,
                            t.sales)
          BULK COLLECT
          INTO v_list
          from (
               ...
               where lower(v.country) like lower( '%' || p_country || '%' ) 
               ) t;
