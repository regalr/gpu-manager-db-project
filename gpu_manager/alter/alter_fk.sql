...
ALTER TABLE memory_chip
  ADD CONSTRAINT manufacturer_memory_chip_fk FOREIGN KEY (manufacturer) REFERENCES manufacturer(man_id);
  
ALTER TABLE memory_chip
  ADD CONSTRAINT mem_type_memory_chip_fk FOREIGN KEY (mem_type) REFERENCES mem_type(mem_id);
  
ALTER TABLE gpu_chip
  ADD CONSTRAINT manufacturer_gpu_chip_fk FOREIGN KEY (foundry) REFERENCES manufacturer(man_id);
